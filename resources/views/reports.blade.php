                    ...
                    <tbody class="bg-white">
                        @foreach ($reports as $report)
                            <tr>
                                ...
                                <td>
                                    <div class="text-sm leading-5 text-gray-900">{{ explode('T', $report['report_start_date'])[0] }}
                                </td>
                                <td>
                                    <div class="text-sm leading-5 text-gray-900">{{ explode('T', $report['report_end_date'])[0] }}
                                </td>
                                <td
