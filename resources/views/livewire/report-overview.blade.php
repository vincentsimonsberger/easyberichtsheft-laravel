<x-app-layout>
    <x-modal name="create-report">
        <x-report.create-report />
    </x-modal>
    <x-modal name="edit-report">
        <x-report.edit-report report= />
    </x-modal>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
            {{ __('Dein Berichtsheft') }}
        </h2>
    </x-slot>
    <div>
        <div class="mt-4">
            <div class="flex flex-wrap -mx-6">
                <div class="w-full px-6 sm:w-1/2 xl:w-1/3 ">
                    <x-secondary-button x-data x-on:click="Livewire.dispatch('open-modal', 'create-report')">
                        ...
                        <tbody class="bg-white">
                            @foreach ($reports as $report)
                                <tr wire:key="{{ $report['id'] }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="text-sm leading-5 text-gray-900">{{ $report['trainee_section'] }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    ...
                                    <td
                                        ...
                                        <div class="text-sm leading-5 text-gray-900 text-start">
                                            ...
                                            <x-secondary-button x-data
                                                x-on:click="Livewire.dispatch('open-modal', 'edit-report')">
                                                <div class="flex items-center justify-between gap-4 p-2">
